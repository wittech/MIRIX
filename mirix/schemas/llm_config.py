...
class LLMConfig(BaseModel):
    """
    Configuration for a Language Model (LLM) model. This object specifies all the information necessary to access an LLM model to usage with Mirix, except for secret keys.
    ...
    def default_config(cls, model_name: str):
        ...
        Args:
            model_name (str): The name of the model (gpt-4, gpt-4o-mini, mirix).
        """
        if model_name == "gpt-4":
            return cls(
                model="gpt-4",
